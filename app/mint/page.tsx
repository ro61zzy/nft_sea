          ...
          <div className="flex flex-col gap-3 max-w-[360px] w-full">
            ...
            <div className="w-full">
              <button
                onClick={handleMint}
                disabled={uploading}
                className="w-full py-3 px-6 rounded-[2px] text-[12px] text-white bg-gradient-to-r from-blue-600 to-pink-600 hover:from-blue-700 hover:to-pink-700 transition-all"
              >
